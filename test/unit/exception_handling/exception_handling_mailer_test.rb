...
class MailerTimeout < StandardError; end

class ExceptionHandlingMailerMock < ExceptionHandling::Mailer
  def deliver
    #Do nothing and return self for matching
    self
  end
end

class ExceptionHandlingMailerTest < ActionMailer::TestCase
